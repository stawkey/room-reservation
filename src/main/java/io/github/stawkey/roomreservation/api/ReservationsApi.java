...
public interface ReservationsApi {
    ...
    default ResponseEntity<Void> cancelReservation(
        @Parameter(name = "id", description = "ID of the reservation", required = true, in = ParameterIn.PATH) @PathVariable("id") Integer id
    ) {
    ...
    @Operation(
        ...
        tags = { "reservations" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Reservation data retrieved successfully", content = {
    ...
    default ResponseEntity<Reservation> getReservation(
        @Parameter(name = "id", description = "ID of the reservation", required = true, in = ParameterIn.PATH) @PathVariable("id") Integer id
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
     ...
     * @param sort Sort results by a specific field (e.g., &#x60;date&#x60;, &#x60;createdAt&#x60;, &#x60;roomName&#x60;) (optional)
     * @param order Sort direction; ascending (&#x60;asc&#x60;) or descending (&#x60;desc&#x60;) (optional, default to asc)
    ...
    @Operation(
        ...
        description = "Returns a paginated collection of reservations with optional filters for date range, room ID and sorting.",
        tags = { "reservations" },
        responses = {
    ...
    default ResponseEntity<Page> listReservation(
        @Parameter(name = "start", description = "Filter reservations starting from this datetime (inclusive, ISO 8601 format)", in = ParameterIn.QUERY) @Valid @RequestParam(value = "start", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) OffsetDateTime start,
        @Parameter(name = "end", description = "Filter reservations ending at this datetime (inclusive, ISO 8601 format)", in = ParameterIn.QUERY) @Valid @RequestParam(value = "end", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) OffsetDateTime end,
        @Parameter(name = "room_id", description = "Filter reservations by one or multiple room IDs", in = ParameterIn.QUERY) @Valid @RequestParam(value = "room_id", required = false) List<Integer> roomId,
        @Parameter(name = "sort", description = "Sort results by a specific field (e.g., `date`, `createdAt`, `roomName`)", in = ParameterIn.QUERY) @Valid @RequestParam(value = "sort", required = false) String sort,
        @Parameter(name = "order", description = "Sort direction; ascending (`asc`) or descending (`desc`)", in = ParameterIn.QUERY) @Valid @RequestParam(value = "order", required = false, defaultValue = "asc") String order,
